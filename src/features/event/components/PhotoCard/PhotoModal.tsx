  ...
  return (
    <div className="group/comment flex items-start justify-between gap-3">
      <div className="flex-1">
        <p className="text-xs">
          <span className="font-black mr-2">{comment.user}</span>
            ...
            <div className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                ...
                <button 
                  onClick={onLike}
                  className={cn(
                    "flex items-center gap-2 px-4 py-2 rounded-full border transition-all font-bold text-xs",
                    hasLiked 
              ...
              <div className="space-y-4">
                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-neutral-300 border-b border-neutral-50 pb-2">
